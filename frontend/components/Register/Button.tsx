    ...
    try {
      ...
      if (valid) {
        dialog.open({
          ...
          content: (<React.Fragment>{t('components:Register.registration_completed')}</React.Fragment>),
          actions: [{label: 'ok'}]
        });
      }
    } catch (e) {
      dialog.open({
        ...
        content: (<React.Fragment>{t('components:Register.registration_failed')}</React.Fragment>),
        actions: [{label: 'ok'}]
      });
    }
