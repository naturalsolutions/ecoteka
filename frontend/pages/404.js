...
const useStyles = makeStyles((theme) => (
    {  
        root: {    
            height: "100vh",    
            width: "100vw",
            background: "no-repeat url('./assets/background_404.svg')",
    ...
    return (    
        <Grid container direction="column" justify="top" alignItems="center" className={classes.root}  >   
            <figure className={classes.figure}>
                <img alt="Erreur 404" src="./assets/erreur_404.svg" width="400px"/>
                <figcaption className={classes.figcaption}>Aucun arbre n'a encore poussé sur cette page ...</figcaption>  
            </figure>
