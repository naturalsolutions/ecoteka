...
# get data from osm
ogr2ogr -f GeoJSON /data/planet.geojson /vsicurl_streaming/https://mirror.init7.net/openstreetmap/pbf/planet-latest.osm.pbf -sql "select * from points where hstore_get_value(other_tags, 'natural') = 'tree'"
